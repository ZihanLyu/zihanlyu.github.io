...
adminLoginBtn.onclick = function () {
    ...
    avatarImg.src = "../images/man_1.png";
    emailInput.value = "admin@smith.edu";
    loginHelp.textContent = "Admin access requires proper authorization!(PASSWORD: admin!)";
    selectAvatarBtn.style.display = "none";
    modal.style.display = "block";
}
